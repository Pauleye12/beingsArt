...
function Info() {
  ...
  return (
    <div className="info_container pt-[40px] px-[20px] bg-[#3d3c70]">
      <div className="info_wrapper">
        <div className="flex flex-col justify-start items-center"> 
          <h1 className="text-center font-[700] text-[#f0f0ff] lg:text-[55px] mb-[20px] ">
            Bringing color back to the DOT
          </h1>
          <p className="my-[20px] text-center max-w-[900px] font-[500] w-full">
            {" "}
